...
import org.junit.runner.RunWith;
    ...
    @CucumberOptions(
           ...
           tags="@tc1103 or @tc1102",
            ...
            // to generate the reports we need plugin runner class
            //reru plugin will hold all the scenarios taht failed durinng execution
            plugin = {"pretty", "html:target/cucmber.html" , "json:target/cucmber.json", "rerun:target/failed.txt"}
    )
